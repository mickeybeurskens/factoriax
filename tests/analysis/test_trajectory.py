...
class TestStatesToTrajectoryWithParams:
    ...
    def _run_short_episode(self, params: EnvParams):
        env = FactoriaXEnv()
    ...
    def test_omitting_params_leaves_scheme_none(self) -> None:
