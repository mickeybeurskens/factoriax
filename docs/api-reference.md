...
| Stable | `make` | function | `(level: factoriax.engine.levels.Level \| str \| None = None, *, obs: Literal['global', 'local'] = 'global', obs_radius: int = 7, achievement_fn: collections.abc.Callable[[factoriax.engine.state.EnvState], jax.jaxlib._jax.Array] \| None = None, auto_reset: bool = False, blocked_actions: collections.abc.Iterable[int] = ()) -> tuple[typing.Any, factoriax.engine.state.EnvParams]` | Build a FactoriaX environment with the canonical wrapper stack. |
