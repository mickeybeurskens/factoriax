    ...
    [
        ...
        (
            ...
            (
                "#8c564b",
                [
                    Action.WITHDRAW_COAL,
                    Action.WITHDRAW_IRON_ORE,
                    Action.WITHDRAW_COPPER_ORE,
                    Action.WITHDRAW_TIN_ORE,
                    Action.WITHDRAW_SILICON,
                    Action.WITHDRAW_IRON_PLATE,
                    Action.WITHDRAW_COPPER_PLATE,
                    Action.WITHDRAW_TIN_PLATE,
                    Action.WITHDRAW_WAFER,
                    Action.WITHDRAW_STEEL,
                    Action.WITHDRAW_CIRCUIT,
                    Action.WITHDRAW_WIRE,
                    Action.WITHDRAW_MOTOR,
                    Action.WITHDRAW_SENSOR,
                    Action.WITHDRAW_BELT,
                    Action.WITHDRAW_MINER,
                    Action.WITHDRAW_ASSEMBLER,
                    Action.WITHDRAW_PALLET,
                    Action.WITHDRAW_BASIC_SCIENCE,
                    Action.WITHDRAW_ADV_SCIENCE,
                    Action.WITHDRAW_ROCKET,
                ],
            ),
        ),
        (
